...
#vector can be used also fot operation like z*2+100 --> First, R multiplied each of the three elements in z by 2. Then it added 100 to each element to get the result you see above
